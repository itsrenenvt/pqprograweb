			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						/*VERDE*/
						document.getElementById("txtResultado"+i).style.backgroundColor = "#1ccd78";
						document.getElementById("txtResultado"+i).style.color = "#07005b";
					}else{
						document.getElementById("txtResultado"+i).style.backgroundColor = "#d64c28";
						document.getElementById("txtResultado"+i).style.color = "#ffffff";
					}
